...
Canny_Thresh <- function(dmat, bitdepth, lowThreshold, ratio = 3L, kernel_size = 3L) {
    .Call('feature2_Canny_Thresh', PACKAGE = 'feature2', dmat, bitdepth, lowThreshold, ratio, kernel_size)
}
